                ...
                {activeOrders.map((order: any) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <CardHeader className={`flex flex-col sm:flex-row items-center justify-between gap-4 pb-3 min-h-[70px] px-5 ${isCancelled ? 'bg-red-50/20' : (isCompletedStatus && !isLiveOrder ? 'bg-emerald-50/20' : isLiveOrder ? 'bg-red-50/20' : isProcessing ? 'bg-indigo-50/40' : 'bg-muted/10')}`}>
